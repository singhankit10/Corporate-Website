        ...
        <div className="footer-top">
          ...
          <div className="footer-column footer-brand">
            ...
            <div className="footer-social">
              ...
              <a href="https://www.linkedin.com/company/xeviant-technologies-consulting/about/" className="social-icon" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
